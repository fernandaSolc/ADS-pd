import {
  ...
  scrollbarSize,
  uncontrollable
} from "./chunk-P7VA4VO7.js";
import "./chunk-QOSB5WUK.js";
import {
  ...
  return _createClass(EventEndingRow2, [{
    ...
    value: function renderShowMore(segments, slot) {
      ...
      if (components2 !== null && components2 !== void 0 && components2.showMore) {
        ...
        return count ? import_react.default.createElement(ShowMore, {
          localizer,
          slotDate,
          slot,
          count,
...
var DateContentRow = function(_React$Component) {
  function DateContentRow2() {
    ...
    _this.renderDummy = function() {
      ...
      }, range2.map(_this.renderHeadingCell)), import_react.default.createElement("div", {
        className: "rbc-row",
  ...
  return _createClass(DateContentRow2, [{
    ...
    value: function render() {
      ...
      }, range2.map(this.renderHeadingCell)), import_react.default.createElement(ScrollableWeekComponent, null, import_react.default.createElement(WeekWrapper, Object.assign({
        isAllDay
      }, eventRowProps, {
        rtl: this.props.rtl
  ...
  return _createClass(TimeGridHeader2, [{
    ...
    value: function render() {
      ...
      return import_react.default.createElement("div", {
        ...
        }, _this3.renderHeaderCells(range2)), import_react.default.createElement(DateContentRow, {
          isAllDay: true,
          rtl,
          getNow: getNow2,
          minRows: 2,
